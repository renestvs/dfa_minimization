...
<body>
	<!-- Minimizer Section -->
	<section style="background-color:#CDE;padding:110px 0px 20px">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2>DFA Creation Tool</h2>
				</div>
			</div>
		</div>
	</section>
	<div id="toolbar" class="designmode">
		<%-- <form method="post" action="dfa_minimizer/results" name="sentMessage" novalidate>--%>
			<span class="left"> 
				<span> 
					<select style="display:none;" id="switchmode">
							<option value="design" data-translated-content="true">Design</option>
					</select>
				</span> 
				<input type="file" id="fileautomaton" style="display: none" /> 
				<input type="file" id="fileprogram" style="display: none" /> 
				<input type="file" id="filequiz" style="display: none" /> 
				...
				<span class="designmode-specific">
				...
				<span> 
					...
					<span class="sep text">&nbsp;</span>  
					<span> 
						<select style="display:none;" id="predef-algos" class="designmode-specific">
							<option data-translated-content="true" value="id">Select an algo</option>
						</select>
						...
						<button id="algo-exec" data-translated-content="true">Execute Program</button>
					</span> 
					<span>
						<button style="display:none;" id="automata-list" class="designmode-specific"
			...
			<span class="right"> 
				<span >
					<button style="display: none;" id="quiz" data-translated-content="true">Load a Quiz</button>
				</span>
			</span>
<%-- 	</form> --%>
	</div>

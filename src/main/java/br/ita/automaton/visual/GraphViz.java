package br.ita.automaton.visual;
...
public class GraphViz
{
	 ...
	 */
	public final static String osName = System.getProperty("os.name").replaceAll("\\s","");

	/**
	 * Load the config.properties file.
	 */
	private final static String cfgProp = "src/main/resources/config.properties";
	 ...
	 */
	public static String TEMP_DIR = configFile.getProperty("tempDirFor" + osName);
	...
	private File writeDotSourceToFile(String str) throws java.io.IOException
	{
		...
		try {
			...
			System.err.println("Error: I/O error while writing the dot source to temp file! = " + GraphViz.TEMP_DIR);
			return null;
		}
		return temp;
	}

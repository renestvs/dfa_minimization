 ...
 * gv.writeGraphToFile(gv.getGraph(gv.getDotSource(), type, representationType),
 * 		out);
 * </pre>
 * 
 * </dd>
...
public class GraphViz {
	 ...
	 */
	public static String TEMP_DIR = configFile.getProperty("outputDir"); 

	/**
	 * Where is your dot program located? It will be called externally.
	 */
	private static String DOT = configFile.getProperty("dotInstalationPath"); 
	 ...
	 */
	private int[] dpiSizes = { 46, 51, 57, 63, 70, 78, 86, 96, 106, 116, 128,
			141, 155, 170, 187, 206, 226, 249 };
